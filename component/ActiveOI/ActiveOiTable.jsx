        ...
        <table className="table1">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredByDate?.map((item) => (
              <tr key={item?.id}>
                <td className="table-cell">{Number(item?.live_nifty).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                <td className="table-cell">{new Date(item?.created_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</td>
                {!checkFive ? (
                  <>
                    <td className="table-cell">{Number(item?.ce_oi).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                    <td className="table-cell">{Number(item?.pe_oi).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                    <td className="table-cell">{Number(item?.net_difference).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                    <td className="table-cell">{item?.pcr}</td>
                    <td className="table-cell">{Number(item?.coi_difference).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                    ...
                    <td className="table-cell">{Number(item?.put_oi_difference).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                  </>
                ) : (
                  <>
                    <td className="table-cell">{Number(item?.large_ce_oi).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                    <td className="table-cell">{Number(item?.large_pe_oi).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                    <td className="table-cell">{Number(item?.large_net_difference).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                    <td className="table-cell">{item?.large_pcr}</td>
                    <td className="table-cell">{Number(item?.large_coi_difference).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
